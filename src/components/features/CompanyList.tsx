            ...
            {hasMoreActive && loadMoreActive && (
              <div className="flex justify-center mt-6">
                <button
                  ...
                  className="px-4 py-2 bg-lime-300 text-black rounded-md hover:bg-lime-400 disabled:opacity-50 disabled:cursor-not-allowed font-medium text-sm"
                >
            ...
            {hasMorePassive && loadMorePassive && (
              <div className="flex justify-center mt-6">
                <button
                  ...
                  className="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed font-medium text-sm"
                >
