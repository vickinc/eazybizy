...
interface TaxTreatmentListProps {
  treatments: TaxTreatment[];
  onEdit: (treatment: TaxTreatment) => void;
  onDelete: (id: string) => void;
  onToggleActive: (id: string) => void;
  sortConfig: TaxTreatmentTableSortConfig;
  onSort: (field: TaxTreatmentTableSortConfig['field']) => void;
  isLoading: boolean;
}
...
const formatApplicability = (applicability: TaxApplicability[]): string => {
...
export const TaxTreatmentList: React.FC<TaxTreatmentListProps> = ({
  treatments,
  onEdit,
  onDelete,
  onToggleActive,
  ...
  const getSortIcon = (field: TaxTreatmentTableSortConfig['field']) => {
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-center">
            <div className="text-sm text-muted-foreground">Loading tax treatments...</div>
          </div>
        </CardContent>
      </Card>
    );
      ...
      <Card>
        <CardContent className="p-6">
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No tax treatments found</h3>
            <p className="text-sm text-muted-foreground">
              No tax treatments match your current filter criteria, or none have been created yet.
            </p>
          </div>
        </CardContent>
      </Card>
    ...
    <>
      ...
      <div className="block md:hidden">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold">Tax Treatments</h3>
      ...
      <Card className="hidden md:block overflow-hidden">
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center justify-between">
            <span className="text-lg font-semibold">Tax Treatments</span>
