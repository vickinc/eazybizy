...
interface CashflowFilterBarProps {
  ...
  searchTerm: string;
  setViewFilter: (filter: 'all' | 'automatic' | 'manual') => void;
...
export const CashflowFilterBar: React.FC<CashflowFilterBarProps> = ({
  viewFilter,
  groupedView,
  selectedPeriod,
  customDateRange,
        ...
        <div className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex border rounded-lg overflow-hidden">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() => setViewFilter('automatic')}
                  ...
                  <Button
                    variant={viewFilter === 'manual' ? 'default' : 'ghost'}
                    size="sm"
                    onClick={() => setViewFilter('manual')}
                    className="rounded-none border-0 px-3 h-9 text-purple-600"
                  >
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <Input
                placeholder="Search cashflow accounts..."
                value={searchTerm}
