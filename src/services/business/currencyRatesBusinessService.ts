...
export class CurrencyRatesBusinessService {
  ...
  static readonly DEFAULT_CRYPTO_CURRENCIES: CurrencyRate[] = [
    ...
    { code: 'ADA', name: 'Cardano', rate: 1.05, type: 'crypto', lastUpdated: this.DEFAULT_LAST_UPDATED },
    { code: 'XRP', name: 'Ripple', rate: 2.45, type: 'crypto', lastUpdated: this.DEFAULT_LAST_UPDATED },
    { code: 'SOL', name: 'Solana', rate: 190, type: 'crypto', lastUpdated: this.DEFAULT_LAST_UPDATED },
    { code: 'DOT', name: 'Polkadot', rate: 8.5, type: 'crypto', lastUpdated: this.DEFAULT_LAST_UPDATED },
    { code: 'DOGE', name: 'Dogecoin', rate: 0.38, type: 'crypto', lastUpdated: this.DEFAULT_LAST_UPDATED },
    { code: 'MATIC', name: 'Polygon', rate: 0.45, type: 'crypto', lastUpdated: this.DEFAULT_LAST_UPDATED },
    { code: 'LTC', name: 'Litecoin', rate: 110, type: 'crypto', lastUpdated: this.DEFAULT_LAST_UPDATED },
    { code: 'BCH', name: 'Bitcoin Cash', rate: 480, type: 'crypto', lastUpdated: this.DEFAULT_LAST_UPDATED },
    { code: 'LINK', name: 'Chainlink', rate: 22.5, type: 'crypto', lastUpdated: this.DEFAULT_LAST_UPDATED },
    { code: 'XLM', name: 'Stellar', rate: 0.38, type: 'crypto', lastUpdated: this.DEFAULT_LAST_UPDATED },
    { code: 'VET', name: 'VeChain', rate: 0.055, type: 'crypto', lastUpdated: this.DEFAULT_LAST_UPDATED },
