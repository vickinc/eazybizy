...
export function useInvoicesManagement(
  ...
  return {
    ...
    // Company Info
    selectedCompanyName: globalSelectedCompany === 'all' || globalSelectedCompany === null ? 'All Companies' : companies.find(c => c.id === globalSelectedCompany)?.name || 'Unknown Company',
    canAddInvoice: globalSelectedCompany !== 'all' && globalSelectedCompany !== null,
